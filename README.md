...
찾아Dream은 에브리타임, 당근마켓 등 여러 커뮤니티에 파편화되어 올라오는 교내 분실물 정보를 하나로 통합합니다. 지도 기반의 실시간 발견 정보를 제공함은 물론, 리워드 시스템을 통해 구성원들이 자발적으로 분실물을 찾아주는 선순환 생태계를 구축하는 숭실대학교 전용 플랫폼입니다.
- 숭실대학교 컴퓨터학부 사용자인터페이스및실습 전공수업 프로젝트
